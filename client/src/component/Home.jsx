...
function Home() {
    ...
    return (
        ...
        <section className="hero is-white is-fullheight dashboard-container content-area  has-background-white-ter ">
          ...
          is-5-fullhd " data-aos="fade-down">
                            <h1 className="title titled is-size-1 mb-6 has-text-weight-bold">
